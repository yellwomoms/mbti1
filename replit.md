...
### 2024-01-14: 성능 최적화 및 언어 시스템 개선
- AI 응답 시간 최적화: 35초 → 5-7초 목표로 토큰 수 600개로 제한
- 다크모드 토글 및 언어 선택 버튼 제거로 UI 간소화
- 자동 언어 감지 시스템 구현 (IP 기반 + 브라우저 설정)
- 번호 매기기 줄바꿈 강화: 다중 정규식 패턴으로 모든 경우 처리
- 연애 꿀팁 5개 → 3개로 축소하여 응답 속도 개선