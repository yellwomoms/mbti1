...
summary:  
"연애할 때 우리는..."으로 시작하는 감성 중심 요약 문단 (200~250자)  
...
→ 각 설명은 200~250자, 말투는 친근하게!
→ 번호는 "1. ", "2. ", "3. " 형식으로 앞에 반드시 줄바꿈을 넣어서 써줘
→ 예시 형식: "텍스트 내용\n\n1. 첫 번째 항목\n\n2. 두 번째 항목\n\n3. 세 번째 항목" 
→ 절대 중요: 번호가 문장 중간에 나오면 안 됨! 반드시 새로운 줄에서 시작!
...
간단하게 ${type1}과 ${type2} 조합 분석해줘.

JSON 형식으로 응답:
{
  "score": 점수(1-100),
  "compatibilityType": "감성 한줄 문구",
  "title": "${type1}과 ${type2}의 궁합",
  "description": "한 줄 설명",
  "characteristics": "연애할 때 우리는...으로 시작하는 200자 분석",
  "tips": "연애 꿀팁 3가지를 번호(1. 2. 3.)와 함께 써줘. 각 번호 앞에 반드시 줄바꿈 넣어서"
}
`;
